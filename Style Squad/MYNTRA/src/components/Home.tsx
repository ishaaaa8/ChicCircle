...
const Home: React.FC<HomeProps> = ({ product }) => {
  return (
    <div className='p-10 flex justify-between'>
      <Link to="/products" state={{ category: "Clothing", product: product }}>
      ...
      <Link to="/products" state={{ category: "Shoes", product: product }}>
      ...
      <Link to="/products" state={{ category: "Furniture", product: product }}>
      ...
      <Link to="/products" state={{ category: "Miscellaneous", product: product }}>
        <div style={{ backgroundImage: `url(${others})`, backgroundRepeat: "no-repeat", backgroundSize: "300px 300px" }}
          className='h-72 w-48 p-2 pt-48'>
          <div className='bg-pink-700 text-orange-100 flex flex-col items-center justify-center'>
